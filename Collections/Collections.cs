...
namespace Collections
{
    internal class Collections // Using for List<>
    {
        ...
        internal static void Main2()
        {
            ...
            // (Enqueued) Element ----------> Elements ---------> Dequeue Element
            // Peek() -> returnreaza primul element din Queue fara ca sa-l stearga
            Queue<int> q = new();
            q.Enqueue(1);
            q.Enqueue(2);
            q.Enqueue(3);
            q.Enqueue(4);
            foreach (int i in q) // Parcurgerea Queue
            {
                Console.WriteLine(i);
            }
        ...
        public static void MainParseNumbers()
        {
        ...
        public static void MainParsingWithSelect()
        {
        ...
        public static void MainSelectStudents()
        {
            Classroom[] classes =
            {
        ...
        #region SortWords 
public static void MainSortWords()
        {
    ...
    class User
    {
        ...
        {
            Console.WriteLine($"{Name} - {CardNumber}");
        }
    }
}